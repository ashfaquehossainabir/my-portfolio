const socialLinks = [
    {
      href: 'https://github.com/ashfaquehossainabir',
                ...
                <form action="https://formspree.io/f/xyzgaqzv" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            ...
                            <input type="text" name="name" id="name" autoComplete="name" required placeholder="Type your name" className="text-field reveal-up"/>
                        </div>

                        <div className="mb-4">
                            <label htmlFor="email" className="label reveal-up">Email</label>
                            <input type="email" name="email" id="email" autoComplete="email" required placeholder="Type your email" className="text-field reveal-up"/>
                        </div>
                    </div>
